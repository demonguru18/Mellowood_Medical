...
namespace MellowoodMedical.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = MellowoodMedicalConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(MellowoodMedicalDbContext context)
        {
            _context = context;
        }
